const QUESTIONS = [
    {
        label: "Какой шаг считается наиболее важным перед внедрением инновационной строительной технологии?",
        answers: [
            "Оценка эффективности и устойчивости технологии",
            "Игнорирование технической документации",
            "Применение без предварительного тестирования",
            "Выбор технологии по визуальному виду",
        ],
    },
    {
        label: "Что обычно считается надёжным показателем качества строительного материала?",
        answers: [
            "Наличие сертификатов и результатов лабораторных испытаний",
            "Цвет упаковки материала",
            "Популярность в социальных сетях",
            "Отсутствие информации о производителе",
        ],
    },
    {
        label: "Как можно эффективно повысить энергоэффективность здания?",
        answers: [
            "Использование инновационных теплоизоляционных материалов",
            "Применение устаревших методов без расчётов",
            "Минимизация вентиляции без учёта норм",
            "Отказ от использования современных технологий",
        ],
    },
    {
        label: "Что является ключевым фактором устойчивого строительства?",
        answers: [
            "Минимизация негативного воздействия на окружающую среду",
            "Максимальное сокращение сроков за счёт качества",
            "Игнорирование требований к энергосбережению",
            "Использование несертифицированных решений",
        ],
    },
    {
        label: "Что отражает успешное внедрение строительной инновации?",
        answers: [
            "Долговечность, энергоэффективность и безопасность объекта",
            "Отсутствие анализа эксплуатационных характеристик",
            "Ограниченное применение в одном проекте без повторного использования",
            "Отказ от мониторинга результатов после строительства",
        ],
    },
];
        ...
        <div class="container quiz-wrapper">
            <div class="quiz-content">
                <div class="content">
                    ...
                    <h3 class="sub-title">Насколько вы разбираетесь в инновациях в строительстве?</h3>
                    <h5 class="text">Ответьте на вопросы по таким темам, как устойчивое строительство, новые строительные материалы, энергосбережение и технологии строительства, и узнайте уровень своих знаний.</h5>

                    <div style="display: flex;justify-content: center;">
                        <button class="btn btn-primary w-100 py-3 first-button" data-action="startQuiz">Начать викторину</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container quiz-wrapper">
            <div class="row quiz-content form-content">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 form-block">
                    <form id="quiz-form">
                        <h2 class="title" style="color: #fff;">Вы почти завершили!</h2>
                        <p class="text" style="color: #fff; margin-bottom: 20px;">
                            Укажите свои данные, чтобы получить индивидуальный результат викторины по темам технологий строительства и инноваций.
                        </p>
                        ...
                        <div class="checkbox" style="color: #fff;">
                            ...
                            <label for="newsletter">Я хочу получать образовательные материалы о технологиях строительства по электронной почте.</label>
                        </div>
